...
function set(obj, key, value) {
    if (!isObjectLike(obj)) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StackAssertionError"](`set: obj is not an object (found: ${obj === null ? "null" : typeof obj})`, {
        obj,
        key,
        value
    });
...
function get(obj, key) {
    if (obj == null) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StackAssertionError"]("get: obj is null or undefined", {
        obj,
        key
    });
...
function getOrUndefined(obj, key) {
    if (obj == null) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StackAssertionError"]("getOrUndefined: obj is null or undefined", {
        obj,
        key
    });
...
function has(obj, key) {
    if (obj == null) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StackAssertionError"]("has: obj is null or undefined", {
        obj,
        key
    });
...
var StackClientInterface = class {
    ...
    async fetchNewAccessToken(refreshToken) {
        ...
        const response = await this._networkRetryException(async ()=>{
            const rawResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["refreshTokenGrantRequest"](as, client, refreshToken.token);
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["processRefreshTokenResponse"](as, client, response);
    ...
    async listProducts(options, session) {
        const queryParams = new URLSearchParams((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$objects$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["filterUndefined"])({
            cursor: options.cursor,
            limit: options.limit !== void 0 ? options.limit.toString() : void 0
        }));
        const path = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$urls$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["urlString"]`/payments/products/${options.customer_type}/${options.customer_id}`;
...
var StackServerInterface = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$interface$2f$client$2d$interface$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StackClientInterface"] {
    ...
    async grantProduct(options) {
        if (!options.productId && !options.product) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StackAssertionError"]("grantProduct requires either productId or product");
        }
        if (options.productId && options.product) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StackAssertionError"]("grantProduct should not receive both productId and product");
        }
        const body = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$objects$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["filterUndefined"])({
            product_id: options.productId,
            product_inline: options.product,
            quantity: options.quantity
        });
        await this.sendServerRequest(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$urls$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["urlString"]`/payments/products/${options.customerType}/${options.customerId}`, {
            method: "POST",
            headers: {
                "content-type": "application/json"
            },
