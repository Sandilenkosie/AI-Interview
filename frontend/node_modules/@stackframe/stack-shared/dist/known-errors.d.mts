...
declare const KnownErrors: {
    ...
    WorkflowTokenDoesNotExist: KnownErrorConstructor<KnownError & KnownErrorBrand<"WORKFLOW_TOKEN_DOES_NOT_EXIST">, []> & {
        errorCode: "WORKFLOW_TOKEN_DOES_NOT_EXIST";
    };
    WorkflowTokenExpired: KnownErrorConstructor<KnownError & KnownErrorBrand<"WORKFLOW_TOKEN_EXPIRED">, []> & {
        errorCode: "WORKFLOW_TOKEN_EXPIRED";
    };
};
