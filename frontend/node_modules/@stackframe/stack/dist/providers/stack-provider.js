...
function NextStackProvider({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_stack_provider_client.StackProviderClient, { app: app[import_stack_app.stackAppInternalsSymbol].toClientJson(), serialized: true, children: [
